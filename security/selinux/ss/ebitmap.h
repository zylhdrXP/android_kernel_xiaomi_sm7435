...
static inline u32 ebitmap_start_positive(struct ebitmap *e,
...
static inline u32 ebitmap_next_positive(struct ebitmap *e,
						 struct ebitmap_node **n,
						 unsigned int bit)
{
	u32 ofs;
...
static inline int ebitmap_node_get_bit(struct ebitmap_node *n, u32 bit)
{
...
int ebitmap_get_bit(struct ebitmap *e, u32 bit);

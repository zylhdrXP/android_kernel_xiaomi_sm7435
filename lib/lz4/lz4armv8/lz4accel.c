...
static inline int __cfi_lz4_decompress_asm(uint8_t **dst_ptr,
					   uint8_t *dst_begin, uint8_t *dst_end,
					   const uint8_t **src_ptr,
					   const uint8_t *src_end, bool dip)
{
	return _lz4_decompress_asm(dst_ptr, dst_begin, dst_end, src_ptr,
				   src_end, dip);
}
...
__cfi_lz4_decompress_asm_noprfm(uint8_t **dst_ptr, uint8_t *dst_begin,
				...
				const uint8_t *src_end, bool dip)
{
	return _lz4_decompress_asm_noprfm(dst_ptr, dst_begin, dst_end, src_ptr,
					  src_end, dip);
}
